...
public class JwtUtil {
    ...
    public static String encode(String id, UserRole role) { // 3 -> dsasdasda.asdasdasd.asdasdsa
        return doEncode(id, role, 60);
    }

    public static String encode(String id) { // 3 -> dsasdasda.asdasdasd.asdasdsa
        return doEncode(id, null, 30);
    }

    public static String doEncode(String id, UserRole role, long minute) { // 3 -> dsasdasda.asdasdasd.asdasdsa
    ...
    public static ProfileJwtDTO decode(String jwt) {
        ...
        return new ProfileJwtDTO(id, UserRole.valueOf(role));
    }
    ...
    public static String getIdFromHeader(HttpServletRequest request, UserRole... requiredRoles) {
        try {
    ...
    public static ProfileJwtDTO getProfileFromHeader(HttpServletRequest request, UserRole... requiredRoles) {
        try {
            ProfileJwtDTO dto = (ProfileJwtDTO) request.getAttribute("profileJwtDto");
            if (requiredRoles == null || requiredRoles.length == 0) {
                return dto;
